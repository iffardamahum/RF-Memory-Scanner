The main goal of this project is to create an automation bot, such as
1. Auto targeting monster
2. AFK Farming

Along with learning about reverse engineering.

![Cheat Engine Structure](./CheatEngine.PNG)
